...
<head>
 ...
 <title>book hostels:ab hostel</title>
		 <link rel="stylesheet"href="css/ab2.css">
		 		 <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-T8Gy5hrqNKT+hzMclPo118YTQO6cYprQmhrYwIiQ/3axmI1hQomh7Ud2hPOy8SP1" crossorigin="anonymous">
 <link rel="stylesheet"href="res/resab2.css">
...
<div class="img1">
  <img style="height:100%;width:100%;"src="image/bnd1.jpg">
   <div class="centered"><h1>AB HOSTEL</h1></div>
  </div>
...
<div class="mySlides fade">
  ...
  <div class="text"><h1>AB HOSTEL</h1></div>
</div>
...
<input type="text"class="textsize" placeholder="Name" required><br>

<input type="email" class="textsize" placeholder="E-mail"><br>
<input type="text"  class="textsize" placeholder="Mobile Number" required><br>
<input type="text" class="textsize" placeholder="Date of Visit / Today's Time"><br>
<input type="text" class="textsize" placeholder="College Name" required>

<br>
<button  type="submit" class="sendb"><b>Send</b></button>
...
<div class="map">
<h1><center>AB HOSTEL MAP</center></h1>
</div>
<P><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.3510881891084!2d77.49345011455581!3d28.46897159821673!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cea10fd1edff5%3A0x6b9f33929e3e3305!2sA+B+HOSTEL+Vidya+Vihar!5e0!3m2!1sen!2sin!4v1551259875675" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe></P>
